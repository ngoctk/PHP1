...
if ($name !== "" && $alphas !== "") {
    if ($alphas !== "") {
        $sql .= " where name like '%$name%' or email like '%$name%' order by name $alphas";
    } else {
        $sql .= " where name like '%$name%' or email like '%$name%'";
    }
}
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="change-pass.php?id=<?= $value['id'] ?>" class="btn btn-danger">Đổi pass</a>
                                <?php endif ?>
                            </td>
                        </tr>
                        <?php endforeach ?>
